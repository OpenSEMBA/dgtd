...
class ExtensiveSolver2DTest : public ::testing::Test
{
protected:
...
TEST_F(ExtensiveSolver2DTest, pec_centered_tris_1dot5D)
{
...
TEST_F(ExtensiveSolver2DTest, pec_centered_quads_1dot5D)
{
	maxwell::Solver solver{
		buildModel(
...
TEST_F(ExtensiveSolver2DTest, pec_upwind_quads_1dot5D)
{
	maxwell::Solver solver{
		buildModel(
...
TEST_F(ExtensiveSolver2DTest, sma_upwind_tris_1dot5D)
{
	maxwell::Solver solver{
		buildModel(
...
TEST_F(ExtensiveSolver2DTest, periodic_upwind_tris)
{
	Mesh m;
	{
...
TEST_F(ExtensiveSolver2DTest, periodic_upwind_quads)
{
	Mesh m;
	{
		Mesh square{Mesh::MakeCartesian2D(9, 9, Element::QUADRILATERAL, false, 1.0, 1.0)};
...
TEST_F(ExtensiveSolver2DTest, box_resonant_modes_pec_tris)
{
...
TEST_F(ExtensiveSolver2DTest, interiorPEC_sma_boundaries)
{
...
TEST_F(ExtensiveSolver2DTest, AutomatedTimeStepEstimator_tri_K2_P3)
{
...
TEST_F(ExtensiveSolver2DTest, pec_centered_quads_1dot5D_AMR)
{
...
TEST_F(ExtensiveSolver2DTest, pec_quads_1dot5D_AMR)
{
	/*The purpose of this test is to verify the functionality of the Maxwell Solver when using
	a centered type flux. A non-conforming mesh is loaded to test MFEM functionalities on the code.
