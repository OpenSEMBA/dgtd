...
TEST_F(MFEMHesthaven1D, checkDGTraceAverageOnlyMatrixO1)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenDGTrace1D(fes_,std::make_pair<double,double>(1.0,0.0)).isApprox(convertMFEMDenseToEigen(buildExpectedAverageDenseMatrix1D(elements, 1).get())));
...
TEST_F(MFEMHesthaven1D, checkDGTraceAverageOnlyMatrixO2)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenDGTrace1D(fes_, std::make_pair<double, double>(1.0, 0.0)).isApprox(convertMFEMDenseToEigen(buildExpectedAverageDenseMatrix1D(elements, 2).get())));
...
TEST_F(MFEMHesthaven1D, checkDGTraceAverageOnlyMatrixO3)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenDGTrace1D(fes_, std::make_pair<double, double>(1.0, 0.0)).isApprox(convertMFEMDenseToEigen(buildExpectedAverageDenseMatrix1D(elements, 3).get())));
...
TEST_F(MFEMHesthaven1D, checkDGTraceAverageOnlyMatrixO4)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenDGTrace1D(fes_, std::make_pair<double, double>(1.0, 0.0)).isApprox(convertMFEMDenseToEigen(buildExpectedAverageDenseMatrix1D(elements, 4).get())));
...
TEST_F(MFEMHesthaven1D, checkDGTraceJumpOnlyMatrixO1)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenDGTrace1D(fes_, std::make_pair<double, double>(0.0, 1.0)).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 1).get())));
...
TEST_F(MFEMHesthaven1D, checkDGTraceJumpOnlyMatrixO2)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenDGTrace1D(fes_, std::make_pair<double, double>(0.0, 1.0)).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 2).get())));
...
TEST_F(MFEMHesthaven1D, checkDGTraceJumpOnlyMatrixO3)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenDGTrace1D(fes_, std::make_pair<double, double>(0.0, 1.0)).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 3).get())));
...
TEST_F(MFEMHesthaven1D, checkDGTraceJumpOnlyMatrixO4)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenDGTrace1D(fes_, std::make_pair<double, double>(0.0, 1.0)).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 4).get())));
...
TEST_F(MFEMHesthaven1D, checkMaxwellDGTraceNoDirO1)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenMaxwellDGTrace1D(fes_, std::vector<maxwell::Direction>{},1.0).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 1).get())));
...
TEST_F(MFEMHesthaven1D, checkMaxwellDGTraceNoDirO2)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenMaxwellDGTrace1D(fes_, std::vector<maxwell::Direction>{}, 1.0).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 2).get())));
...
TEST_F(MFEMHesthaven1D, checkMaxwellDGTraceNoDirO3)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenMaxwellDGTrace1D(fes_, std::vector<maxwell::Direction>{}, 1.0).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 3).get())));
...
TEST_F(MFEMHesthaven1D, checkMaxwellDGTraceNoDirO4)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenMaxwellDGTrace1D(fes_, std::vector<maxwell::Direction>{}, 1.0).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 4).get())));
...
TEST_F(MFEMHesthaven1D, checkMaxwellDGTraceXDirO1)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenMaxwellDGTrace1D(fes_, std::vector<maxwell::Direction>{maxwell::Direction::X}, 1.0).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 1).get())));
...
TEST_F(MFEMHesthaven1D, checkMaxwellDGTraceXDirO2)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenMaxwellDGTrace1D(fes_, std::vector<maxwell::Direction>{maxwell::Direction::X}, 1.0).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 2).get())));
...
TEST_F(MFEMHesthaven1D, checkMaxwellDGTraceXDirO3)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenMaxwellDGTrace1D(fes_, std::vector<maxwell::Direction>{maxwell::Direction::X}, 1.0).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 3).get())));
...
TEST_F(MFEMHesthaven1D, checkMaxwellDGTraceXDirO4)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenMaxwellDGTrace1D(fes_, std::vector<maxwell::Direction>{maxwell::Direction::X}, 1.0).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 4).get())));
...
TEST_F(MFEMHesthaven1D, checkMaxwellDGTraceXXDirO1)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenMaxwellDGTrace1D(fes_, std::vector<maxwell::Direction>{maxwell::Direction::X, maxwell::Direction::X}, 1.0).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 1).get())));
...
TEST_F(MFEMHesthaven1D, checkMaxwellDGTraceXXDirO2)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenMaxwellDGTrace1D(fes_, std::vector<maxwell::Direction>{maxwell::Direction::X, maxwell::Direction::X}, 1.0).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 2).get())));
...
TEST_F(MFEMHesthaven1D, checkMaxwellDGTraceXXDirO3)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenMaxwellDGTrace1D(fes_, std::vector<maxwell::Direction>{maxwell::Direction::X, maxwell::Direction::X}, 1.0).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 3).get())));
...
TEST_F(MFEMHesthaven1D, checkMaxwellDGTraceXXDirO4)
{
	...
	for (int elements = 2; elements < 5; elements++) {
		...
		EXPECT_TRUE(buildEigenMaxwellDGTrace1D(fes_, std::vector<maxwell::Direction>{maxwell::Direction::X, maxwell::Direction::X}, 1.0).isApprox(convertMFEMDenseToEigen(buildExpectedJumpDenseMatrix1D(elements, 4).get())));
