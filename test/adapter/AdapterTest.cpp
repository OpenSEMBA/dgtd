...
TEST_F(MaxwellProblemTest, 3D_PEC_Centered)
{
	auto data{ parseJSONfile("3D_PEC") };
	data["solver_options"]["solver_type"] = "centered";
	auto solver{ buildSolver(data) };
...
TEST_F(MaxwellProblemTest, 3D_PEC_Upwind)
{
	std::string case_data{ "3D_PEC" };
	auto solver{ buildSolver(case_data) };
