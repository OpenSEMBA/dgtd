...
//	 const Math::Real impP,
//	 const Math::Real admP,
//	 const Math::Real impAv,
//	 const Math::Real admAv);
...
//	Math::Real impPAv, admPAv, imp1Av, adm1Av;
//	Math::Real *rhsEx, *rhsEy, *rhsEz, *rhsHx, *rhsHy, *rhsHz;
//	const Math::Real *dEx, *dEy, *dEz, *dHx, *dHy, *dHz;
//	const Math::Real *dresEx, *dresEy, *dresEz, *dresHx, *dresHy, *dresHz;
//	Math::Real nx[np*nfp], ny[np*nfp], nz[np*nfp];
//	Math::Real rnx[np*nfp], rny[np*nfp], rnz[np*nfp];
//	Math::Real cnx[np*nfp], cny[np*nfp], cnz[np*nfp];
//};
//
