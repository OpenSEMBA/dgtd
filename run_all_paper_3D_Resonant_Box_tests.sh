...
mpirun -np 8 ./build/gnu-release-cuda/bin/opensemba_dgtd \
  -i ./testData/maxwellInputs/3D_Resonant_Box/3D_Resonant_Box_BLEG_H1_P1/3D_Resonant_Box_BLEG_H1_P1.json \
  --device cuda

mpirun -np 8 ./build/gnu-release-cuda/bin/opensemba_dgtd \
  -i ./testData/maxwellInputs/3D_Resonant_Box/3D_Resonant_Box_BLEG_H1_P2/3D_Resonant_Box_BLEG_H1_P2.json \
  --device cuda

mpirun -np 8 ./build/gnu-release-cuda/bin/opensemba_dgtd \
  -i ./testData/maxwellInputs/3D_Resonant_Box/3D_Resonant_Box_BLEG_H1_P3/3D_Resonant_Box_BLEG_H1_P3.json \
  --device cuda
